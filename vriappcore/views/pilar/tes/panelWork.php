	          ...
	          <div class="timeline-panel danger">
	            ...
	            <div class="timeline-body">
	              <p>La Plataforma de Investigación Universitaria Integrada a la Labor Académica con Responsabilidad (PILAR), 
                     tiene por objetivo simplificar el proceso de investigación brindandote las herramientas necesarias para realizar tu Informe de tesis, además de realizarlo on-line teniendo la información a primera mano del procedimiento de presentación, revisión, dictaminación y aprobación de proyectos y trabajos de tesis.</p>
	              <p>
	              	<b> RECOMENDACIONES</b>
	              	...
	              	<ul>
	              		...
	              		<li>Elija su Asesor de proyecto de tesis, Los 3 jurados de tesis serán sorteados por el Coordinador de investigación a travez de la Plataforma PILAR.</li>
	              	</ul>
                  <p>
