...
<div class="modal-content">
	...
	<div class="modal-body">
		<div class="container-fluid">
			<div id="envia">
			<h5 class="text-justify">La Coordinación de Investigación, está recibiendo cuatro (04) ejemplares anillados del  corregido según las observaciones del Jurado. <br><br> Dada la conformidad de la Tabla N° 1  del reglamento, el borrador se encuentra listo para el proceso de Dictamen.
			...
			<button type="button" class="btn btn-success btn-md btn-opt" onclick="if( confirm('Señor Coordinador esta seguro de que el Tesista Entregó 4 Ejemplares del ?') ) lodPanel('envia','cordinads/recepEjemplares/<?php echo $tram->Id;?>')";
