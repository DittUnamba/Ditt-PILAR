...
-->
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" rel="home" href="<?= base_url("pilar") ?>" title="Universidad Nacional Micaela Bastidas de Apurímac | Vicerrectorado de Investigación">
                    <img class="img-responsive" style="max-width:160px; margin-top: -15px;" src="<?= base_url("vriadds/pilar/imag/logos-u-v-p.png"); ?>">
                </a>
            </div>
    ...
    <div class="container info-pilar margin">
        ...
        <h4><i>Universidad Nacional Micaela Bastidas de Apurímac</i></h4>
    </div>
    <div class="container ">
