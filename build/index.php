...
<?php
// 
// version mandrakeada 11:06 14/03/23
//
...
// Generate secure password hash - http://revistas.unap.edu.pe >>>>help2
$auth_users = array(
    'adminojs' => '$2y$10$sZEGhqY3KBGsK3gv8WrOQOPo2EgTWkGjRUgV41osEf4eOQdj2Kksm', //pass
    'rpm' => '$2y$10$K3jK3ahPo9JdDBB4fLDb8OUS.6QKO0cre0dv4VYOjZn7iIB9VDrX2' //
);
...
$directories_users = array(
	...
	'194947' => '../--apps/194947',
    '081363' => '../--apps/081363',
    'raraujo' => '../--apps/raraujo',
    'escalafon' => '../escalafon',
	'jtisnado' => '../--apps/jtisnado'
	//'vlady' => ['../antroa/','../epg/','../rd/'],
	//'vlady' => '../vlady',
...
/*
//--------------------------------------------------------------------------------------------------------------------------------------------
defined('FM_ROOT_URL') || define('FM_ROOT_URL', ($is_https ? 'https' : 'http') . '://' . $http_host . (!empty($folder) ? '/' . $folder : ''));
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                                ...
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
										   ...
										   -->
											<svg width="100%" height="80px" viewBox="0 0 1196 1196" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" stroke-linejoin="round"><path fill="#706cf5" d="M697 0c296 0 497 201 497 497v224c-10 284-208 476-497 476H500C203 1196 2 1002 2 705V491C2 204 192 12 473 1l27-1z"/><path d="M615 963a381 381 0 0040-2l-25-50-15 1a314 314 0 01-281-174 712 712 0 01-71-42 365 365 0 00352 267zm313-342h51v-47a365 365 0 00-666-181c-79 11-133 40-145 84-12 45 20 97 83 147 17 13 36 26 57 39 69 42 171 85 272 113l-22-66a959 959 0 01-257-112 312 312 0 0144-159 314 314 0 01584 159v2a348 348 0 01-1 21zM286 440l-3 6a363 363 0 00-31 113c-26-26-39-51-33-73 6-21 30-37 67-46zm305 228h53l89 248h-53zm183-5h55l-76 218-30-80zm117 132h60l76 120h-60zm80-9l24 37s35-19 35-53c0-54-17-106-98-106s-92 27-92 64v187h48V722s-5-13 51-13 47 67 32 77z"/></svg>
										   <!-- <center> VRI 2023 </center> -->
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
							<!--
                            <a href="https://revistas.unap.edu.pe/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">CCP Programmers</a> &mdash;&mdash;
							-->
							PErmelro &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="http://revistas.unap.edu.pe" target="_blank" class="app-v-title"> Admin <?php echo 1; ?></a></h3></p>
                        <p>support: 931476096</p>
                        <p>Mail Us: <a href="mailto:permelro@unap.edu.pe">mail</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="http://revistas.unap.edu.pe" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="http://revistas.unap.edu.pe" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <!-- <div class="col-3 d-none d-sm-block"><a href="https://repositorio.unap.edu.pe" target="_blank" class="float-right text-muted">Tiny File Manager <?php echo VERSION; ?></a></div> -->
        <?php else: ?>
            <!-- <div class="col-12"><a href="https://repositorio.unap.edu.pe" target="_blank" class="float-right text-muted">Tiny File Manager <?php echo VERSION; ?></a></div> -->
        <?php endif; ?>
    </div>
</form>
...
<head>
    ...
    <meta name="description" content="Manage your files efficiently File Manager">
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="VRI-DEV">
    <meta name="author" content="------">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <?php if($favicon_path) { echo '<link rel="icon" href="'.fm_enc($favicon_path).'" type="image/png">'; } ?>
...
function lng($txt) {
	...
	$tr['es']['okay']           = 'Acepto';
    $tr['es']['AppName']        = 'Mini Admin';             $tr['es']['AppTitle']           = '--Admin--';
    $tr['es']['Login']          = 'Ingresar';               $tr['es']['Username']           = 'Nombre';
    $tr['es']['Password']       = 'Contraseña';             $tr['es']['Logout']             = 'Salir';
    $tr['es']['Move']           = 'Mover';                  $tr['es']['Copy']               = 'Copiar';
    $tr['es']['Save']           = 'Grabar';                 $tr['es']['SelectAll']          = 'Seleccionar';
    $tr['es']['UnSelectAll']    = 'Deseleccionar';          $tr['es']['File']               = 'Archivo';
    $tr['es']['Back']           = 'Regresar';               $tr['es']['Size']               = 'Tamaño';
    $tr['es']['Perms']          = 'Permisos';               $tr['es']['Modified']           = 'Modificado';
    $tr['es']['Owner']          = 'Owner';                  $tr['es']['Search']             = 'Buscar';
    $tr['es']['NewItem']        = 'Nuevo';                  $tr['es']['Folder']             = 'Carpeta';
    $tr['es']['Delete']         = 'Borrar';                 $tr['es']['Rename']             = 'Renombrar';
    $tr['es']['CopyTo']         = 'Copiar a';               $tr['es']['DirectLink']         = 'Acceso directo';
    $tr['es']['UploadingFiles'] = 'Subir Archivos';         $tr['es']['ChangePermissions']  = 'Cambia permiso';
    $tr['es']['Copying']        = 'Copiando';               $tr['es']['CreateNewItem']      = 'Create Nuevo';
    $tr['es']['Name']           = 'Nombre';                 $tr['es']['AdvancedEditor']     = 'Editor Avanzado';
    $tr['es']['Actions']        = 'Acciones';               $tr['es']['Folder is empty']    = 'Folder esta vacio';
    $tr['es']['Upload']         = 'Upload';                 $tr['es']['Cancel']             = 'Cancelar';
    $tr['es']['InvertSelection']= 'Invertir Select';        $tr['es']['DestinationFolder']  = 'Folder destino';
    $tr['es']['ItemType']       = 'Item Type';              $tr['es']['ItemName']           = 'Nombre item';
    $tr['es']['CreateNow']      = 'Create Now';             $tr['es']['Download']           = 'Descargar';
    $tr['es']['Open']           = 'Abrir';                  $tr['es']['UnZip']              = 'Descomprimir';
    $tr['es']['UnZipToFolder']  = 'UnZip to folder';        $tr['es']['Edit']               = 'Editar';
    $tr['es']['NormalEditor']   = 'Normal Editor';          $tr['es']['BackUp']             = 'Back Up';
    $tr['es']['SourceFolder']   = 'Folder origen';          $tr['es']['Files']              = 'Archivos';
    $tr['es']['Move']           = 'Mover';                   $tr['es']['Change']             = 'Cambiar';
    $tr['es']['Settings']       = 'Configuracion';          $tr['es']['Language']           = 'Idiomas';        
    $tr['es']['ErrorReporting'] = 'Reporte de error';        $tr['es']['ShowHiddenFiles']    = 'Mostrar ocultos';
    $tr['es']['Help']           = 'Ayuda';                   $tr['es']['Created']            = 'Creado';
    //$tr['es']['Help Documents'] = 'Ayuda de doc';            $tr['es']['Report Issue']       = 'Report Issue';
    $tr['es']['Generate']       = 'Generar';                 $tr['es']['FullSize']           = 'Tamaño total';              
    $tr['es']['HideColumns']    = 'Hide Perms/Owner columns';$tr['es']['You are logged in'] = 'Estas dentro del sistema';
    $tr['es']['Nothing selected']   = 'Nothing selected';   $tr['es']['Paths must be not equal']    = 'Paths must be not equal';
    $tr['es']['Renamed from']       = 'Renamed from';       $tr['es']['Archive not unpacked']       = 'Archive not unpacked';
    $tr['es']['Deleted']            = 'Deleted';            $tr['es']['Archive not created']        = 'Archive not created';
    $tr['es']['Copied from']        = 'Copied from';        $tr['es']['Permissions changed']        = 'Permissions changed';
    $tr['es']['to']                 = 'to';                 $tr['es']['Saved Successfully']         = 'Saved Successfully';
    $tr['es']['not found!']         = 'not found!';         $tr['es']['File Saved Successfully']    = 'File Saved Successfully';
    $tr['es']['Archive']            = 'Archive';            $tr['es']['Permissions not changed']    = 'Permissions not changed';
    $tr['es']['Select folder']      = 'Select folder';      $tr['es']['Source path not defined']    = 'Source path not defined';
    $tr['es']['already exists']     = 'already exists';     $tr['es']['Error while moving from']    = 'Error while moving from';
    $tr['es']['Create archive?']    = 'Create archive?';    $tr['es']['Invalid file or folder name']    = 'Invalid file or folder name';
    $tr['es']['Archive unpacked']   = 'Archive unpacked';   $tr['es']['File extension is not allowed']  = 'File extension is not allowed';
    $tr['es']['Root path']          = 'Root path';          $tr['es']['Error while renaming from']  = 'Error while renaming from';
    $tr['es']['File not found']     = 'File not found';     $tr['es']['Error while deleting items'] = 'Error while deleting items';
    $tr['es']['Moved from']         = 'Moved from';         $tr['es']['Generate new password hash'] = 'Generate new password hash';
    $tr['es']['Login failed. Invalid username or password'] = 'Login error. clave o contraseña erradas';
    $tr['es']['password_hash not supported, Upgrade PHP version'] = 'password_hash not supported, Upgrade PHP version';
    $tr['es']['Advanced Search']    = 'Busqueda avanzada';    $tr['es']['Error while copying from']    = 'Error while copying from';
    $tr['es']['Invalid characters in file name']                = 'Invalid characters in file name';
    $tr['es']['FILE EXTENSION HAS NOT SUPPORTED']               = 'FILE EXTENSION HAS NOT SUPPORTED';
    $tr['es']['Selected files and folder deleted']              = 'Selected files and folder deleted';
    $tr['es']['Error while fetching archive info']              = 'Error while fetching archive info';
    $tr['es']['Delete selected files and folders?']             = 'Delete selected files and folders?';
    $tr['es']['Search file in folder and subfolders...']        = 'Search file in folder and subfolders...';
    $tr['es']['Access denied. IP restriction applicable']       = 'Access denied. IP restriction applicable';
    $tr['es']['Invalid characters in file or folder name']      = 'Invalid characters in file or folder name';
    $tr['es']['Operations with archives are not available']     = 'Operations with archives are not available';
    $tr['es']['File or folder with this path already exists']   = 'File or folder with this path already exists';
